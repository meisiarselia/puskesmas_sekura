    ...
    <div class="p-0 p-sm-3">
        <div class="card card-body border-0 shadow-sm">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <form action="{{ route('akreditasi.update') }}" class="d-flex" style="gap: .5rem" method="POST"
            ...
            <div class="text-center">
                <img class="mt-3" src="{{ asset($gambar) }}" id="previewImage" style="max-height: 100vh;width: auto !important">
            </div>
        </div>
    </div>
@endsection
